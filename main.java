...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (!arestas.isEmpty()) {
            ...
            final String verticeAlvo = melhorVertice;
            
            arestas.removeIf(aresta ->
                    aresta.origem.equals(verticeAlvo) || aresta.destino.equals(verticeAlvo)
            );
        }
        ...
        System.out.println("\nTamanho da cobertura: " + cobertura.size());
        
        System.out.println("\nComplexidade aproximada da implementação: O(V^2 * E)");
        System.out.println("(Implementação baseada em heurística gulosa de aproximação)");
